# HP Elite C1030 / x360 13c Chromebook Hackintosh
 ...
 在HP Elite C1030/x360 13c Chromebook机型上实现黑苹果。没时间写详细安装教程，简单说下思路，首先解锁刷bios（这个自行参考[Chromebook研究院](http://120.79.199.53?_blank)相关教程），目前统一使用macOS定制版BIOS，可以在BIOS文件价下载，或者使用脚本`cd; curl -LO ethanthesleepy.one/macos/firmware-util.sh && sudo bash firmware-util.sh
`。
...
| 内置外放             | 禁用               | 声卡驱动`ChultraSOF.kext`测试阶段，可使用蓝牙音响或耳机平替（推荐小米、小度便携智能音箱，惠普那款也可以）                                                               |
| 3.5mm耳机接口        | 禁用               | 受声卡无法驱动影响，无法使用                                                                              |
| 内置麦克风           | 禁用               | 受声卡无法驱动影响，无法使用                                                                              |
| SD卡                | 禁用               | 目前暂时无法驱动，已在SSDT禁用以省电                                                                      |
| 指纹                | 禁用               | 目前暂时无法驱动，已在SSDT禁用以省电                                                                      |
---------------------------------------------------------------------------------------------------------------------------------------------------
